...
(* OASIS_START *)
(* DO NOT EDIT (digest: e1d2884934fd7d7d98e9b6b37b4f6602) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://objsize.forge.ocamlcore.org/";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-W"; "-Wall"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "objsize"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_command = [(OASISExpr.EBool true, ("$tests", []))];
                      test_custom =
                        {
                           pre_command = [(OASISExpr.EBool true, None)];
                           post_command = [(OASISExpr.EBool true, None)]
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for objsize";
                      doc_authors = ["Dmitry Grebeniuk"];
                      doc_abstract = None;
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\182\223f\020ij\230\252\251\187 a\243\129\250\198";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
